...
const TRANSLATIONS = {
  en: {
    ...
    redeemLabel: "⭐ Redeem", needMore: "more needed",
  ...
  es: {
    ...
    redeemLabel: "⭐ Canjear", needMore: "faltan",
  ...
  fr: {
    ...
    redeemLabel: "⭐ Échanger", needMore: "manquantes",
  ...
  de: {
    ...
    redeemLabel: "⭐ Einlösen", needMore: "fehlen noch",
  ...
  it: {
    ...
    redeemLabel: "⭐ Riscatta", needMore: "mancanti",
  ...
  pt: {
    ...
    redeemLabel: "⭐ Resgatar", needMore: "faltam",
    reward1Title: "5% Off Amazon", reward1Desc: "Código único",
