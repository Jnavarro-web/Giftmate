...
function MainApp({session, profile, setProfile}) {
  ...
  const TABS = [{id:"home",icon:"🏠",label:"Home"},{id:"search",icon:"🔍",label:"Search"},{id:"groups",icon:"👥",label:"Groups"},{id:"concierge",icon:"💬",label:"AI"},{id:"profile",icon:"👤",label:"Profile"},{id:"stars",icon:"⭐",label:"Stars"}];
